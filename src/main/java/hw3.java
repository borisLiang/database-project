...
public class hw3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        userValue2.setText("-1");

        userValue3.setText("-1");

        userValue4.setText("-1");

        userValue5.setText("-1");
...
//        }
    ...
    private void busRevTableDisplay(int index) throws SQLException{
        ...
        Double starValueInt = Double.valueOf(starValue.getText());
        String voteConditionStr = numCondition.getSelectedItem().toString();
        int voteValueDou = Integer.valueOf(numValue.getText());


        String query = hw3.busReviewScene(con1, true, arr[index].toString(),
                fromDateStr, toDateStr, voteConditionStr, voteValueDou, starConditionStr, starValueInt
        );
...
//        jDateChooser1.getDate();
    ...
    private void userRevTableDisplay(int index) throws SQLException{
       Object[] arr =  hw3.tableDisplayFirstColumn(con1, userTableQuery);
        ...
        String[] columns = {"Business Name", "Stars!!!","Text"};
